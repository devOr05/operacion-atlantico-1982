...
export const CrtScreen: React.FC<CrtScreenProps> = ({ children }) => {
  ...
  return (
    <div className={`relative w-full h-full min-h-screen overflow-hidden ${modeClass} bg-[var(--crt-bg,#050e07)] text-[var(--crt-primary,#55ff77)] font-mono-military`}>
      {/* Marco diegético del monitor militar de los 80 */}
      <div className="relative w-full h-full min-h-screen flex flex-col crt-bezel crt-flicker">
